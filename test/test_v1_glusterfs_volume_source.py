...
from k8sclient.models.v1_glusterfs_volume_source import V1GlusterfsVolumeSource
...
class TestV1GlusterfsVolumeSource(unittest.TestCase):
    ...
    def testV1GlusterfsVolumeSource(self):
        ...
        """
        model = k8sclient.models.v1_glusterfs_volume_source.V1GlusterfsVolumeSource()
