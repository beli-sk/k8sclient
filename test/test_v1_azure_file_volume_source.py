...
from k8sclient.models.v1_azure_file_volume_source import V1AzureFileVolumeSource
...
class TestV1AzureFileVolumeSource(unittest.TestCase):
    ...
    def testV1AzureFileVolumeSource(self):
        ...
        """
        model = k8sclient.models.v1_azure_file_volume_source.V1AzureFileVolumeSource()
