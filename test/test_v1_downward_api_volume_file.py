...
from k8sclient.models.v1_downward_api_volume_file import V1DownwardAPIVolumeFile
...
class TestV1DownwardAPIVolumeFile(unittest.TestCase):
    ...
    def testV1DownwardAPIVolumeFile(self):
        ...
        """
        model = k8sclient.models.v1_downward_api_volume_file.V1DownwardAPIVolumeFile()
