...
from k8sclient.models.v1beta1_horizontal_pod_autoscaler_list import V1beta1HorizontalPodAutoscalerList
...
class TestV1beta1HorizontalPodAutoscalerList(unittest.TestCase):
    ...
    def testV1beta1HorizontalPodAutoscalerList(self):
        ...
        """
        model = k8sclient.models.v1beta1_horizontal_pod_autoscaler_list.V1beta1HorizontalPodAutoscalerList()
