...
from k8sclient.models.v1beta1_network_policy_ingress_rule import V1beta1NetworkPolicyIngressRule
...
class TestV1beta1NetworkPolicyIngressRule(unittest.TestCase):
    ...
    def testV1beta1NetworkPolicyIngressRule(self):
        ...
        """
        model = k8sclient.models.v1beta1_network_policy_ingress_rule.V1beta1NetworkPolicyIngressRule()
