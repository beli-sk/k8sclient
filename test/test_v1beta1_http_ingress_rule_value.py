...
from k8sclient.models.v1beta1_http_ingress_rule_value import V1beta1HTTPIngressRuleValue
...
class TestV1beta1HTTPIngressRuleValue(unittest.TestCase):
    ...
    def testV1beta1HTTPIngressRuleValue(self):
        ...
        """
        model = k8sclient.models.v1beta1_http_ingress_rule_value.V1beta1HTTPIngressRuleValue()
