...
from k8sclient.models.v1beta1_network_policy_list import V1beta1NetworkPolicyList
...
class TestV1beta1NetworkPolicyList(unittest.TestCase):
    ...
    def testV1beta1NetworkPolicyList(self):
        ...
        """
        model = k8sclient.models.v1beta1_network_policy_list.V1beta1NetworkPolicyList()
