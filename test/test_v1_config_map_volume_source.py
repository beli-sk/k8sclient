...
from k8sclient.models.v1_config_map_volume_source import V1ConfigMapVolumeSource
...
class TestV1ConfigMapVolumeSource(unittest.TestCase):
    ...
    def testV1ConfigMapVolumeSource(self):
        ...
        """
        model = k8sclient.models.v1_config_map_volume_source.V1ConfigMapVolumeSource()
