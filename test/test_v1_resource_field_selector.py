...
from k8sclient.models.v1_resource_field_selector import V1ResourceFieldSelector
...
class TestV1ResourceFieldSelector(unittest.TestCase):
    ...
    def testV1ResourceFieldSelector(self):
        ...
        """
        model = k8sclient.models.v1_resource_field_selector.V1ResourceFieldSelector()
