...
from k8sclient.models.v1_host_path_volume_source import V1HostPathVolumeSource
...
class TestV1HostPathVolumeSource(unittest.TestCase):
    ...
    def testV1HostPathVolumeSource(self):
        ...
        """
        model = k8sclient.models.v1_host_path_volume_source.V1HostPathVolumeSource()
