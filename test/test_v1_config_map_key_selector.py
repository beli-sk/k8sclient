...
from k8sclient.models.v1_config_map_key_selector import V1ConfigMapKeySelector
...
class TestV1ConfigMapKeySelector(unittest.TestCase):
    ...
    def testV1ConfigMapKeySelector(self):
        ...
        """
        model = k8sclient.models.v1_config_map_key_selector.V1ConfigMapKeySelector()
