...
from k8sclient.models.v1beta1_third_party_resource_list import V1beta1ThirdPartyResourceList
...
class TestV1beta1ThirdPartyResourceList(unittest.TestCase):
    ...
    def testV1beta1ThirdPartyResourceList(self):
        ...
        """
        model = k8sclient.models.v1beta1_third_party_resource_list.V1beta1ThirdPartyResourceList()
