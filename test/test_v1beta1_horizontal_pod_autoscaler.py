...
from k8sclient.models.v1beta1_horizontal_pod_autoscaler import V1beta1HorizontalPodAutoscaler
...
class TestV1beta1HorizontalPodAutoscaler(unittest.TestCase):
    ...
    def testV1beta1HorizontalPodAutoscaler(self):
        ...
        """
        model = k8sclient.models.v1beta1_horizontal_pod_autoscaler.V1beta1HorizontalPodAutoscaler()
