...
from k8sclient.models.v1beta1_network_policy_spec import V1beta1NetworkPolicySpec
...
class TestV1beta1NetworkPolicySpec(unittest.TestCase):
    ...
    def testV1beta1NetworkPolicySpec(self):
        ...
        """
        model = k8sclient.models.v1beta1_network_policy_spec.V1beta1NetworkPolicySpec()
